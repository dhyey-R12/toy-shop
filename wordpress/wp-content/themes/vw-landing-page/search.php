            ...
            if($vw_landing_page_theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        ...
                        printf( esc_html__( 'Results For: %s','vw-landing-page'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                        ...
                        <div class="navigation">
                            <?php
                                ...
                                the_posts_pagination( array(
                                    'prev_text' => __( 'Previous page', 'vw-landing-page' ),
                                    'next_text' => __( 'Next page', 'vw-landing-page' ),
                                    'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-landing-page' ) . ' </span>',
                                ) );
                            ?>
