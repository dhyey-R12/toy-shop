...
function vw_landing_page_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-landing-page' ) .'</h3>';
...
function vw_landing_page_scripts() {
	...
	wp_enqueue_script( 'vw-landing-page-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
/* admin bar */
function vw_landing_page_my_filter_head(){
	remove_action('wp_head','_admin_bar_bump_cb');
}
add_action('get_header','vw_landing_page_my_filter_head');
...
if ( ! function_exists( 'vw_landing_page_credit' ) ) {
	function vw_landing_page_credit(){
		echo "<a href=".esc_url(VW_LANDING_PAGE_CREDIT).">".esc_html__('Landing Page WordPress Theme','vw-landing-page')."</a>";
	}
}
