...
function demo($attr){
	...
	// echo "hello";
	// echo "hello1";
	$img = '<img src="http://localhost/toy%20shop/wordpress/wp-content/uploads/2020/06/5bb5c77fe7ca6c69b821cffc_about-image-p-1600-1024x455.jpeg" width="'.$array['width'].'" height="'.$array['height'].'">';

	return $img;
	/*C:\Users\dhyey\OneDrive\Desktop\@WallpapersGram4k - dragon-temple-4k-tj.jpg 
	 */
}
add_shortcode('code','demo');
// add_shortcode('code','demo');
