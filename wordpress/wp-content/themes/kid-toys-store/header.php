          ...
          <div class=" col-lg-2 col-md-4 headericons">
            <div class="row">
              <div class="search-box col-lg-4 col-md-4 col-4 p-0">
                <span class="search-image"><a href="#" onclick="kid_toys_store_search_open()"><span class="screen-reader-text"><?php esc_html_e('Search Open','kid-toys-store'); ?></span></a></span>
              </div>
              <div class="serach_outer">
                <div class="serach_inner">
                  <?php get_search_form(); ?>
                </div>
                <div class="closepop"><a href="#" onclick="kid_toys_store_search_close()"><i class="far fa-window-close"></i><span class="screen-reader-text"><?php esc_html_e('Search Closed','kid-toys-store'); ?></span></a></div>
              </div>
              <div class="col-lg-4 col-md-4 col-4 p-0">
                <span class="cart_icon">
                  ...
                  <?php } ?>
                  <a href="<?php echo esc_url( get_permalink( get_option('woocommerce_cart_page_id') ) ); ?>"><img role="img" src="<?php echo esc_html(get_template_directory_uri().'/images/icon.png'); ?>" alt="<?php esc_html_e('Cart Image','kid-toys-store'); ?>"><span class="screen-reader-text"><?php esc_html_e('Cart Image','kid-toys-store'); ?></span></a>
                </span>
              </div>
              <div class="col-lg-4 col-md-4 col-4 p-0">
                <a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>"><img role="img" src="<?php echo esc_url( get_theme_mod('',get_template_directory_uri().'/images/accounticon.png') ); ?>" alt="<?php esc_html_e('MyAccount Image','kid-toys-store'); ?>" class="account-img"><span class="screen-reader-text"><?php esc_html_e('MyAccount Image','kid-toys-store'); ?></span></a>
              </div>
            </div>
          </div>
        </div>
