			          	...
			          	<div class="carousel-caption">
				            <div class="inner_carousel">
				                ...
				                <?php if ( get_theme_mod('kid_toys_store_slider_button_text','Read More') != '' && get_theme_mod('kid_toys_store_slider_button',true) != '') {?>
				              		<a class="read-more" href="<?php esc_html(the_permalink()); ?>"><?php echo esc_html( get_theme_mod('kid_toys_store_slider_button_text',__('SHOP NOW', 'kid-toys-store')) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('kid_toys_store_slider_button_text',__('SHOP NOW', 'kid-toys-store')) ); ?></span></a>
				              	<?php }?>
				            </div>
			          	</div>
			        </div>
